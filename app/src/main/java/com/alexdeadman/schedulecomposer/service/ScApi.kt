...
interface ScApi {
    ...
    suspend fun getToken(@Body rb: RequestBody): AuthToken
    ...
    @POST(CLASSROOMS)
    suspend fun postClassroom(@Body rb: RequestBody)

    @PUT("$CLASSROOMS{id}/")
    suspend fun putClassroom(@Path("id") id: Int, @Body rb: RequestBody)
    ...
    @POST(DIRECTIONS)
    suspend fun postDirection(@Body rb: RequestBody)

    @PUT("$DIRECTIONS{id}/")
    suspend fun putDirection(@Path("id") id: Int, @Body rb: RequestBody)

    @DELETE("$DIRECTIONS{id}/")
    suspend fun deleteDirection(@Path("id") id: Int): Response<Unit>
    ...
    @POST(DISCIPLINES)
    suspend fun postDiscipline(@Body rb: RequestBody)

    @PUT("$DISCIPLINES{id}/")
    suspend fun putDiscipline(@Path("id") id: Int, @Body rb: RequestBody)

    @DELETE("$DISCIPLINES{id}/")
    suspend fun deleteDiscipline(@Path("id") id: Int): Response<Unit>
    ...
    @POST(GROUPS)
    suspend fun postGroup(@Body rb: RequestBody)

    @PUT("$GROUPS{id}/")
    suspend fun putGroup(@Path("id") id: Int, @Body rb: RequestBody)
    ...
    @POST(LECTURERS)
    suspend fun postLecturer(@Body rb: RequestBody)

    @PUT("$LECTURERS{id}/")
    suspend fun putLecturer(@Path("id") id: Int, @Body rb: RequestBody)

    @DELETE("$LECTURERS{id}/")
    suspend fun deleteLecturer(@Path("id") id: Int): Response<Unit>
    ...
    @POST(SYLLABUSES)
    suspend fun postSyllabus(@Body rb: RequestBody)

    @PUT("$SYLLABUSES{id}/")
    suspend fun putSyllabus(@Path("id") id: Int, @Body rb: RequestBody)

    @DELETE("$SYLLABUSES{id}/")
    suspend fun deleteSyllabus(@Path("id") id: Int): Response<Unit>
